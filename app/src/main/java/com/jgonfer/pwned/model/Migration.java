...
public class Migration implements RealmMigration {
    ...
    public void migrate(final DynamicRealm realm, long oldVersion, long newVersion) {
        ...
        if (newVersion == 3) {
            RealmObjectSchema userInfoSchema = schema.get("UserInfo");

            // Combine 'firstName' and 'lastName' in a new field called 'fullName'
            userInfoSchema
                    .addField("counterExecutions", int.class, FieldAttribute.REQUIRED)
                    .addField("openedGooglePlay", boolean.class, FieldAttribute.REQUIRED)
                    .addField("shouldSayThanksRate", boolean.class, FieldAttribute.REQUIRED);
            oldVersion++;
        }
        /*
        /************************************************
